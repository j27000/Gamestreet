          ...
          <ul className="text-slate-700 dark:text-slate-100">
            <li className="mt-1 mb-5">
              ...
              <div className="flex items-center my-1">
                <input onChange={() => (dispatch({ type: "SORT_BY", payload: { SortBy: "low" } }))} checked={state.SortBy === "low" || false} id="price-sort-1" type="radio" value="" name="price-sort" className="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 dark:bg-gray-700 dark:border-gray-600" />
                <label htmlFor="price-sort-1" className="ml-2 text-sm font-medium text-gray-900 dark:text-gray-300">Price - Low to High</label>
              </div>
              <div className="flex items-center my-1">
                <input onChange={() => (dispatch({ type: "SORT_BY", payload: { SortBy: "high" } }))} checked={state.SortBy === "high" || false} id="price-sort-2" type="radio" value="" name="price-sort" className="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 dark:bg-gray-700 dark:border-gray-600" />
            ...
            <li className="mt-1 mb-5">
              ...
              <div className="flex items-center my-1">
                <input onClick={() => (dispatch({
                  type: "BEST_SELLER_ONLY", payload: {
                    bestSelleronly: !state.bestSelleronly
                  }
                }))} checked={state.bestSelleronly} id="best-seller" type="checkbox" value="" className="w-4 h-4 text-blue-600 bg-gray-100 rounded border-gray-300 dark:bg-gray-700 dark:border-gray-600" />
                <label htmlFor="best-seller" className="ml-2 text-sm font-medium text-gray-900 dark:text-gray-300">Best Seller Only</label>
              </div>
              <div className="flex items-center my-1">
                <input onClick={() => (dispatch({ type: "ONLY_IN_STOCK", payload: { onlyInStock: !state.onlyInStock } }))}
                  checked={state.onlyInStock} id="only-instock" type="checkbox" value="" className="w-4 h-4 text-blue-600 bg-gray-100 rounded border-gray-300 dark:bg-gray-700 dark:border-gray-600" />
